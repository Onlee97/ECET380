...
test_set_raw = tfds.load('tf_flowers', split='train[:10%]',as_supervised=True) # first 10% of train data
valid_set_raw = tfds.load('tf_flowers', split='train[10%:25%]',as_supervised=True) # 10% to 25%
train_set_raw = tfds.load('tf_flowers', split='train[-75%:]',as_supervised=True) #last 75% of train data
...
# Load sample images
china = load_sample_image("china.jpg") / 255  #need to install "python -m pip install pillow"
